    ...
    stages {
        ...
        stage('Migrate') {
            steps {
                ...
                sleep 10 // allow the app to complete migrations
            }
        }
        stage('Test') {
            steps {
                ...
                sh 'docker-compose exec -T app coverage run manage.py test --parallel'
            ...
            steps {
                ...
                sh """
                    ssh -v centos@pmfellowship.tiger-park.com \"
                        ...
                        sudo systemctl restart central_django
                        sudo systemctl status central_django
                    \"
                """
            }
        }
